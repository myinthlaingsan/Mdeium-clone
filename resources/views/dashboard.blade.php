                ...
                @foreach ($posts as $post)
                    <div
                        ...
                        <div class="p-5 flex-1">
                            ...
                            <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">{{$post -> content}}
                            </p>
                            <a href="#"
                        ...
                        <a href="#">
                            <img class="w-48 h-48 rounded-t-lg" src="https://flowbite.com/docs/images/blog/image-1.jpg" alt="" />
                        </a>
                    </div>
                @endforeach
